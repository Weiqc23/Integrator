function [tplot,yplot,zplot] = GMRES_SDC(n, m, h0, t0, y0, tfinal)
...
gtol=set_gtol;
    ...
    k0 = n*m; %20; %(n+1)*m; % k0=max(n+4,81);  % Number of terms in Krylov subspace for the 
                       % restarted GMRES(k0).
    ...
    %%%%%%%%%%%%%%%%%%%%%%Main Subroutine%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      [tplot,yplot,zplot]=sdcgmres(m,t0,tfinal,y0,h0,n,kmax,gtol,etol,k0);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

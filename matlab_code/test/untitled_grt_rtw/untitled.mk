...
## Generated on : Mon Dec 08 09:15:53 2025
...
START_DIR                 = D:/weiqc/work/Integrator/matlab_code/test
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/untitled_grt_rtw/rt_nonfinite.c $(START_DIR)/untitled_grt_rtw/untitled.c $(START_DIR)/untitled_grt_rtw/untitled_data.c
...
OBJS = rt_logging.obj rt_nonfinite.obj untitled.obj untitled_data.obj
...
%.obj : $(START_DIR)/untitled_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/untitled_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/untitled_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

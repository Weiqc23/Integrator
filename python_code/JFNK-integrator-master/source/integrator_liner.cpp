    ...
    bool do_print)
{
    ...
    // cout << "res: " << endl;
    // cout << (I - h * A).fullPivLu().solve(rhs + h * (B * u(t))) << endl;
    return (I - h * A).fullPivLu().solve(rhs + h * (B * u(t)));
}
    ...
    bool do_print)
{
    ...
    for (int i = 0; i < n_nodes; i++)
    {
        ...
        else
        {
            ...
            y.row(i) = (backward_euler_node(f_eval, A, B, u, t(i), h, rhs, rhs, be_tol, do_print)).transpose();
        }
    ...
    bool do_print)
{
    ...
    VectorXd y_new = backward_euler_node(f_eval, A, B, u, t, h, rhs, y_old, be_tol, do_print);
    ...
    bool do_print)
{
    ...
    for (int i = 0; i < n_nodes; i++)
    {
        ...
        else
        {
            ...
            auto [y_temp, d_temp] = sdc_node(f_eval, A, B, u, t(i), h, rhs, y_old.row(i).transpose(), be_tol, do_print);
    ...
    bool do_print)
{
    ...
    while (!is_converged && k < n_iter_max_sdc)
    {
        ...
        // else
        // {
        tie(y_sdc, d) = sdc_sweep(f_eval, A, B, u, t, y0, y_sdc, F, S, S_p, be_tol, do_print);
        // }
    ...
    bool do_print)
{
    ...
    tie(y_sdc, Y_sdc, D_sdc, is_converged) =
        sdc(f_eval, A, B, u, t, y0, y_approx, S, S_p, 2, be_tol, sdc_tol);
    ...
    // cout << "is_stiff: " << is_stiff << endl;
    // cout << "n_iter_max: " << n_iter_max << endl;
    while ((!is_converged) && (!is_stiff) && (i < n_iter_max))
    {
        ...
        else
        {
            ...
            tie(y_sdc, Y_sdc, D_sdc, is_converged) =
                sdc(f_eval, A, B, u, t, y0, y_sdc, S, S_p, 1, be_tol, sdc_tol);
    ...
    bool do_print)
{
    ...
    {
        tie(y, Y, D, is_converged) = sdc(f_eval, A, B, u, t, y0, y, S, S_p, k_sdc, be_tol, sdc_tol);
    ...
    bool do_print)
{
    ...
    tie(y_init, Y_init, D_init, is_converged, is_stiff, ratios) =
        jfnk_initial(f_eval, A, B, u, t, y0, y_approx, S, S_p, spectral_radius, be_tol, sdc_tol);
    ...
    if ((!is_converged) && is_stiff)
    {
        tie(y, Y, D, is_converged) =
            jfnk_iterations(f_eval, A, B, u, t, y0, y_init, S, S_p, n_iter_max_newton, be_tol, sdc_tol, do_print);
    }
    ...
    bool do_print)
{
    ...
    MatrixXd y_be = backward_euler(f_eval, A, B, u, t, y0, S_p, be_tol);
    // cout << "y0: " << endl;
    // cout << y0 << endl;
    // cout << "y_be: " << endl;
    // cout << y_be << endl;
    ...
    tie(y, Y, D, is_converged, is_stiff, ratios) =
        jfnk(f_eval, A, B, u, t, y0, y_be, S, S_p, spectral_radius, n_iter_max_newton, be_tol, sdc_tol, do_print);
    ...
    bool do_print)
{
    ...
    for (int i = 0; i < n_steps; i++)
    {
        ...
        // }
        tie(y, Y, D, is_converged, is_stiff, ratios) =
            jfnk_step(f_eval, A, B, u, p, dt, nodes, v0, n_iter_max_newton, be_tol, sdc_tol);
    ...
    bool do_print)
{
    ...
    while (t0 < t_final && !do_stop)
    {
        ...
        // cout << "t0: " << t0 << endl;
        // cout << "h: " << h << endl;
        tie(t1, y1, Y1, D1) = jfnk_uniform(f_eval, A, B, u, t0, t0 + h, 1, p, v0, n_iter_max_newton, be_tol, sdc_tol);
        // cout << "-------t1信息：---------- " << endl;
        // cout << t1 << endl;
        // cout << "-------y1信息：---------- " << endl;
        // cout << y1 << endl;
        // tie(t2, y2, Y2, D2) = jfnk_uniform(f_eval, A, B, u, t0, t0 + h, 2, p, v0, n_iter_max_newton, be_tol, sdc_tol);
        // cout << "t2信息： " << endl;
        // cout << t2 << endl;
        // cout << "y2信息： " << endl;
        // cout << y2 << endl;
        ...
        // cout << v0 << endl;
        // tie(t, y, Y, D) = jfnk_uniform(f_eval, A, B, u, t0, t0 + h, 1, p, v0, n_iter_max_newton, be_tol, sdc_tol);

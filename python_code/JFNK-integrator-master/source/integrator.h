...
// backward euler 单步
VectorXd backward_euler_node(std::function<VectorXd(double, const VectorXd &)> f_eval,
                             double t,
                             double h,
                             const VectorXd &rhs,
                             const VectorXd &x0,
...
MatrixXd backward_euler(std::function<VectorXd(double, const VectorXd &)> f_eval,
                        const VectorXd &t,
                        const VectorXd &y0,
                        const MatrixXd &S_p,
                        double be_tol = BE_TOL,
...
std::tuple<MatrixXd, std::vector<MatrixXd>, std::vector<MatrixXd>, bool>
jfnk_iterations(
    std::function<VectorXd(double, const VectorXd &)> f_eval,
    const VectorXd &t,
    const VectorXd &y0,
...
std::tuple<MatrixXd, std::vector<MatrixXd>, std::vector<MatrixXd>, bool, bool, VectorXd>
jfnk(
    function<VectorXd(double, const VectorXd&)> f_eval, 
    const VectorXd &t,                                  
    const VectorXd &y0,                                 
...
// JFNK 单步
std::tuple<MatrixXd, std::vector<MatrixXd>, std::vector<MatrixXd>, bool, bool, VectorXd>
jfnk_step(std::function<VectorXd(double, const VectorXd &)> f_eval,
          const Params &p,
          double dt,
          const VectorXd &t,
          const VectorXd &y0,
...
std::tuple<VectorXd, MatrixXd,
           ...
           std::vector<std::vector<MatrixXd>>>
jfnk_uniform(std::function<VectorXd(double, const VectorXd &)> f_eval,
             double t_init,
             double t_final,
             int n_steps,
             const Params &p,
...
std::tuple<VectorXd, MatrixXd,
           ...
           std::vector<std::vector<MatrixXd>>,
           std::vector<double>>
jfnk_adaptive(std::function<VectorXd(double, const VectorXd &)> f_eval,
              double t_init,
              double t_final,
              double dt_init,
              const Params &p,
